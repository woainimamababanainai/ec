...
extern const struct hook_data __hooks_plt_reset[];
extern const struct hook_data __hooks_plt_reset_end[];
...
#endif
extern const struct hook_data __hooks_msec[];
extern const struct hook_data __hooks_msec_end[];
